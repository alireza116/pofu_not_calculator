  ...
  return (
    <>
      <main className="h-screen flex">
        <div className="flex-1 bg-zinc-900 p-24 overflow-auto">
          <Link
          ...
          <h1 className="text-left font-['Arima'] text-2xl leading-snug mt-16 text-stone-500 italic">
            Make Your Carbon Labels for ...
          </h1>
          <div className="flex items-center">
            {/* <AirplaneTilt size={42} className="text-stone-400"/> */}
            <h1 className="text-left font-['Arima'] text-6xl leading-normal text-gray-200 italic">
        ...
        <div className="flex-1 overflow-y-scroll p-12">
          ...
          <div
            className={`${bgColor[visualUnit]} flex-1 p-10 rounded-3xl`}
            ref={ref}
          >
            <div className="flex items-center">
              ...
              />
              <div className="grow"></div>
              <div className="mx-5 font-['Arima'] text-stone-400 italic text-md">
                Print & Stick : Suitcase - Passport - Flight Pass
              </div>
              <Circle size={32} weight="fill" color="#ffffff" />
            </div>
            <div className="divide-dotted divide-y-4 divide-zinc-700">
              ...
              <div className="font-['Arima'] pt-2 mb-2">
                Carbon Footprint : Flight Edition
              </div>
            ...
            <div className="flex items-center">
              ...
              />
              <div className="grow"></div>
              <div className="mx-5 font-['Arima']">
                POFU : NOT A CACULATOR{" "}
                <span className="font-bold">@ IDEO 2023</span>
              </div>
              <Circle size={32} weight="fill" color="#ffffff" />
            </div>
          </div>
