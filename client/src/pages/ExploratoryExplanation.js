  ...
  return (
    <>
      <main className="h-[1300px] m-36">
        <Link
          className="mx-5 text-left font-['Arima'] flex mx-0 text-2xl"
          to="/home"
        >
        ...
        <Fade bottom>
          <div className="px-10">
            ...
            <p className="text-left font-['Arima'] text-6xl leading-normal mb-20">
              Carbon Footprint Drawing Tool. Lorem ipsum dolor sit amet,
      ...
      <div className="p-36 bg-indigo-200">
        <Fade bottom>
          <div className="px-10">
            ...
            <p className="text-left font-['Arima'] text-6xl leading-normal mb-20">
              Scenario Simulations. Lorem ipsum dolor sit amet, consectetur
