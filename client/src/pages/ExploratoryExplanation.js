        ...
        <Fade bottom>
          <div className="px-10">
            ...
            <p className="text-left font-['Arima'] text-6xl leading-normal mb-20">
              A carbon footprint drawing tool that asks the user to draw their trend prediction before revealing the actual one.
            </p>
          </div>
        </Fade>
      </div>
      <div className="p-36 bg-red-200">
        <Fade bottom>
          <div className="px-10">
            ...
            <p className="text-left font-['Arima'] text-6xl leading-normal mb-20">
              A scenario simulation that allows the user to explore the causal relationships between product parameters and carbon footprint 
              by simulating the future in animated scenes based on the users' input.
            </p>
          </div>
        </Fade>
      </div>
      ...
      <div className="px-36 pt-10 pb-36 h-[60px]">
                <Fade bottom>
                    <div className="grid grid-cols-3">
                        <Link className="mx-5 text-left font-['Arima'] flex mx-0 text-2xl justify-self-start" to="/carbon-labeling">
                            <ArrowLeft size={28} className="px-0"/>&nbsp;Generative Carbon Labeling
                        </Link>
                        <Link className="justify-self-center" to="/home">
                            <HouseSimple size={36} className="justify-self-center"/>
                        </Link>
                        <Link className="mx-5 text-left font-['Arima'] flex mx-0 text-2xl justify-self-end" to="/interactive-data-vis">
                            Interactive Data Visualization  &nbsp;<ArrowRight size={28} className="px-0"/>
                        </Link>
                    </div>
                </Fade>
            </div>
